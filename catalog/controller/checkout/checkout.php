...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
		...
		if ((!$this->cart->hasProducts() && empty($this->session->data['vouchers'])) || ((!$this->cart->hasStock() && !$this->config->get('config_stock_checkout')) || (!$this->cart->allowPreOrder() && $this->config->get('config_stock_checkout')) )) {
