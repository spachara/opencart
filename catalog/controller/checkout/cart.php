...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if ((!$this->cart->hasStock() && !$this->cart->allowPreOrder()) && (!$this->config->get('config_stock_checkout') || $this->config->get('config_stock_warning'))) {
			...
			foreach ($products as $product) {
				...
				$data['products'][] = array(
					...
					'stock'     => $product['stock'] || $product['preorder'] ? true : !(!$this->config->get('config_stock_checkout') || $this->config->get('config_stock_warning')),
